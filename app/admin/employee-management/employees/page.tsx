          ...
          <form onSubmit={handleAddEmployee} className="space-y-5">
            ...
            <div>
              ...
              <select
                ...
                className="mt-2 w-full rounded-lg border border-gray-300 px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none cursor-pointer"
              >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-lg font-medium transition cursor-pointer disabled:opacity-50"
            >
